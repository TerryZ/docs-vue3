...
`SelectMenu` provides various component combination application scenario examples

## Multiple types of menu item

Combination of menu items, single selection and multiple selection
...
## Multiple grouped item selection with search

Application scenarios that combine text search, multiple grouping, and single selection functions
...
## Multiple level menu with selection

<MenuMultipleLevelWithSelection />

The icons used in the menu are from [Bootstrap Icons](https://icons.getbootstrap.com)
...
A comment content input module
