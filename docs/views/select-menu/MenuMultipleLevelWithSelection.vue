<template>
  <div class="mb-3">
    <div class="mb-3">Interests: {{ interests }}</div>
    ...
    <SelectMenuBody>
      ...
      <SelectMenuChildLevel>
        <template #trigger>
          <SelectMenuItem>
            <template #prepend>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-translate b-svg-icon" viewBox="0 0 16 16">
      ...
      <SelectMenuChildLevel>
        <template #trigger>
          <SelectMenuItem>
            <template #prepend>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-lightbulb b-svg-icon" viewBox="0 0 16 16">
      ...
      <SelectMenuItem>
        <template #prepend>
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-question-circle b-svg-icon" viewBox="0 0 16 16">
      ...
      <SelectMenuItem>
        <template #prepend>
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gear b-svg-icon" viewBox="0 0 16 16">
      ...
      <SelectMenuItem>
        <template #prepend>
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-right b-svg-icon" viewBox="0 0 16 16">
